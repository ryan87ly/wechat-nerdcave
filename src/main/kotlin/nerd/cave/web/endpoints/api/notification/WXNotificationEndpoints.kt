package nerd.cave.web.endpoints.api.notification
...
import nerd.cave.service.payment.hasProceeded
...
class WXNotificationEndpoints(
    ...
    private suspend fun paymentCallback(ctx: RoutingContext) {
        ...
        val payment = paymentService.fetchPayment(paymentId)
        if (payment == null) {
        ...
        try {
            paymentService.redeemPayment(payment, transactionId, paymentResult)
        } catch (e: Exception) {
